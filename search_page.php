...
<section class="search-form">
   <form action="" method="post">
      <input type="text" name="search_box" placeholder="search here..." maxlength="100" class="box" value="<?= isset($_POST['search_box']) ? htmlspecialchars($_POST['search_box']) : ''; ?>" required>
      <button type="submit" class="fas fa-search" name="search_btn"></button>
   </form>
</section>

<section class="products" style="padding-top: 2rem; min-height:100vh;">
   <?php if(isset($_POST['search_box']) OR isset($_POST['search_btn'])): ?>
      <h1 class="heading">Search Results for "<?= htmlspecialchars($_POST['search_box'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"</h1>
   <?php else: ?>
